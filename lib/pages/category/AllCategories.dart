                      ...
                      child: new InkWell(
                          onTap: () {
                            ...
                            MyWidgets.showGreenToast(
                                "Size=" + data.categoryList[index].categoryName);
                            Navigator.of(context).pop();
                            try {
                              Navigator.push(
                                  context,
                                  MaterialPageRoute(
                                  //  builder: (context) => DetailScreen(data.categoryList[index].categoryId.toString(),data.categoryList[index].categoryName.toString()),
